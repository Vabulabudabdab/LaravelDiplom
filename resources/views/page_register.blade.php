                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 ml-auto mr-auto">
                                <div class="card p-4 rounded-plus bg-faded">
                                    @if(!empty(session()->get('alreadyExists')))
                                        <div class="alert alert-danger text-dark" role="alert">
                                            <strong>Уведомление!</strong> {{session()->get('alreadyExists')}}
                                            {{session()->forget('alreadyExists')}}
                                        </div>
                                    @endif

                                    <form id="js-login" action="/checkregister" method="post">
                                        {{csrf_field()}}
