...
<body>
    <div class="blankpage-form-field">
        ...
        <div class="card p-4 border-top-left-radius-0 border-top-right-radius-0">
            ...
            @if(!empty(session()->get('forLogin')))
                <div class="alert alert-success">
                    {{session()->get('forLogin')}}
                </div>   {{session()->forget('forLogin')}}

            @elseif(!empty(session()->get('notExists')))
                <div class="alert alert-success">
                    {{session()->get('notExists')}}
                </div>   {{session()->forget('notExists')}}

            @elseif(!empty(session()->get('notValid')))
                <div class="alert alert-success">
